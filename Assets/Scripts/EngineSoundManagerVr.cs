...
{
    [RequireComponent(typeof(WheelVehicleVr))]
    [RequireComponent(typeof(AudioSource))]

    public class EngineSoundManagerVr : MonoBehaviour
    {
        ...
        private WheelVehicleVr _vehicle;

        void Start()
        {
            _source = GetComponent<AudioSource>();
            _vehicle = GetComponent<WheelVehicleVr>();
        }
