...
public class CarControllerAIInputSystem : MonoBehaviour, ICarController
{
    ...
    private CarControllerSystem m_CarController;    // Reference to actual car controller we are controlling
    ...
    private void FixedUpdate()
    {
        ...
        else
        {
            ...
            if (m_Rigidbody.velocity.magnitude > (m_CarController.MaxSpeed / 3.6f))
            {
    ...
    private void OnCollisionStay(Collision col)
    {
        ...
        {
            var otherAI = col.rigidbody.GetComponent<CarControllerAIInputSystem>();
            if (otherAI != null)
            {
